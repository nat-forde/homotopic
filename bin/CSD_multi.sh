...
indir2=/KIMEL/tigrlab/external/pond/pipelines/fmriprep/out/ciftify/$subj
...
dwi2response dhollander dMRI.nii.gz wm_response.txt gm_response.txt csf_response.txt -fslgrad bvecs bvals
...
#mrview dMRI.nii.gz -tractography.load prob.tck
