...
len_by_type <- function(subids, edgedir) {
  ...
  for (i in 1:length(subids)) {
    ...
    if (file.exists(edge.file)) {
      ...
      lenZ$HO_L[i] <- mean(filter(edges_nonzero, FCtype == "Homotopic", length < 40)$theseZ, na.rm=TRUE)
      lenZ$HO_M[i] <- mean(filter(edges_nonzero, FCtype == "Homotopic", length >= 40, length < 80)$theseZ, na.rm=TRUE)
      lenZ$HO_S[i] <- mean(filter(edges_nonzero, FCtype == "Homotopic", length >= 80)$theseZ, na.rm=TRUE)
      lenZ$HO_na[i] <- mean(filter(edges, FCtype == "Homotopic", length == 0)$theseZ, na.rm=TRUE)
      
      lenZ$HE_L[i] <- mean(filter(edges_nonzero, FCtype == "Heterotopic", length < 40)$theseZ, na.rm=TRUE)
      lenZ$HE_M[i] <- mean(filter(edges_nonzero, FCtype == "Heterotopic", length >= 40, length < 80 )$theseZ, na.rm=TRUE)
      lenZ$HE_S[i] <- mean(filter(edges_nonzero, FCtype == "Heterotopic", length >= 80)$theseZ, na.rm=TRUE)
      lenZ$HE_na[i] <- mean(filter(edges, FCtype == "Heterotopic", length == 0)$theseZ, na.rm=TRUE)
      
      lenZ$I_L[i] <- mean(filter(edges_nonzero, FCtype == "Intrahemispheric", length < 40)$theseZ, na.rm=TRUE)
      lenZ$I_M[i] <- mean(filter(edges_nonzero, FCtype == "Intrahemispheric", length >= 40 , length < 80)$theseZ, na.rm=TRUE)
      lenZ$I_S[i] <- mean(filter(edges_nonzero, FCtype == "Intrahemispheric", length >= 80)$theseZ, na.rm=TRUE)
      ...
      lenDW$HO_L[i] <- mean(filter(edges_nonzero, FCtype == "Homotopic", length < 40)$raw, na.rm=TRUE)
      lenDW$HO_M[i] <- mean(filter(edges_nonzero, FCtype == "Homotopic", length >= 40, length < 80)$raw, na.rm=TRUE)
      lenDW$HO_S[i] <- mean(filter(edges_nonzero, FCtype == "Homotopic", length >= 80)$raw, na.rm=TRUE)
      
      lenDW$HE_L[i] <- mean(filter(edges_nonzero, FCtype == "Heterotopic", length < 40)$raw, na.rm=TRUE)
      lenDW$HE_M[i] <- mean(filter(edges_nonzero, FCtype == "Heterotopic", length >= 40, length < 80 )$raw, na.rm=TRUE)
      lenDW$HE_S[i] <- mean(filter(edges_nonzero, FCtype == "Heterotopic", length >= 80)$raw, na.rm=TRUE)
      
      lenDW$I_L[i] <- mean(filter(edges_nonzero, FCtype == "Intrahemispheric", length < 40)$raw, na.rm=TRUE)
      lenDW$I_M[i] <- mean(filter(edges_nonzero, FCtype == "Intrahemispheric", length >= 40 , length < 80)$raw, na.rm=TRUE)
      lenDW$I_S[i] <- mean(filter(edges_nonzero, FCtype == "Intrahemispheric", length >= 80)$raw, na.rm=TRUE)
