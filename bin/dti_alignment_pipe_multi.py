...
S_fname = "/scratch/nforde/homotopic/bin/multi_subs.csv"
...
for i in range(num_sub):
    ...
    try:
        ...
        dti_total = process_sub + 'dwi_multi_concat.nii.gz'
        ...
        dti_ec = process_sub + 'reg_dwi_multi.nii' ##name registered dwi output file
        ...
        print('Performing registration correction to volume: ' + str(b0_ref)) ## just registering them, b0_red is 0
        ...
        with open('/scratch/nforde/homotopic/bin/fixthese.txt', 'a+') as fixthese:
            fixthese.write('{}\n'.format(subjects[i]))
        continue
